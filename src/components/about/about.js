        ...
        <div id='about'>
           <Banner text="A propos" />
                <div className='alignement'>
                    <p className='hobby'>💪 En dehors du monde du développement, je suis une passionnée de musculation. Chaque séance d'entraînement me permet de me ressourcer et de trouver l'équilibre nécessaire pour exceller dans mon travail de développeur.</p>
